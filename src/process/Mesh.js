...
export class Mesh {
    static init() {
        ...
        const sphereData = icosphere(5, true);
        Mesh.sphere = new IndexedVAO()
        .setIBO(new IBO(sphereData.triangles))
        .addVBO(new VBO(sphereData.vertices, 3, 0))
        .addVBO(new VBO(sphereData.uv, 2, 1))
        .addVBO(new VBO(sphereData.vertices, 3, 2));

        ///////////////////////////////////////////

        const cubeData = cube();
        Mesh.cube = new IndexedVAO()
        .setIBO(new IBO(cubeData.triangles))
...
const icosphere = (order = 4, uvMap = false) => {
